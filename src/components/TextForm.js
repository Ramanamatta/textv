  ...
  return (
    <>
        <div className='container' style={{color: props.mode==='light'?'black':'white'}}>
            ...
            <button className='btn btn-primary mx-1'onClick={handelUpClick}>change to upperCase</button>
            <button className='btn btn-primary mx-1'onClick={handelLoClick}>change to LowerCase</button>
            ...
            <button className='btn btn-primary mx-1'onClick={handelRemoveSpave}>Remove Extra Sapes</button>
        </div>
